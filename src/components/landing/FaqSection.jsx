...
const faqs = [
  ...
  },
  {
    ...
    a: 'Мостовидные конструкции из 3–4 единиц — 3–4 рабочих дня. Более протяжённые мосты (5+ единиц) — 4–5 дней в зависимости от сложности.',
  },
  {
    q: 'Какой срок изготовления съёмных протезов?',
    a: 'Съёмные акриловые и нейлоновые протезы готовятся за 3–5 рабочих дней. Металлические бюгельные конструкции — 5–7 дней.',
  },
  {
  ...
  },
  {
    ...
    a: 'Готовая работа упаковывается и передаётся курьером прямо в клинику. Всё просто и удобно — вам не нужно ни за чем следить.',
  },
  {
    q: 'Можно ли забрать заказ самостоятельно?',
    a: 'Да, вы можете забрать готовую работу из лаборатории самостоятельно по адресу: г. Казань, ул. Челюскина, д. 25. Режим работы: Пн–Пт с 9:00 до 18:00.',
  },
];
